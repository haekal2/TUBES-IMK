      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav navbar-right">
            <a class="dropdown-toggle" data-toggle="dropdown" ><img src="images/in.png" alt=""> Indonesia<span class="fa fa-angle-down"></span></a>
            
            <li class="active"><a href="#banner">Home</a></li>
            <li><a href="../pendanaan/pendaftaranpendanaan.html">Pendanaan</a></li>
            <li><a href="../peminjaman/dat.php">Peminjaman</a></li>
            <li><a href="#portfolio">Project Investasi</a></li>
  ...
  <div id="portfolio">
    <div class="container">
      <div class="page-title text-center">
        <h1>PROJECT INVESTASI INFAST</h1>
        <p> InFast adalah platform Peer to Peer Lending Indonesia pertama yang melayani pendanaan online P2P Lending dan pinjaman online tanpa agunan. </p>
      ...
      <div class="row">
        <div class="col-lg-12">
          <ul id="portfolio-flters">
            ...
            <li data-filter=".filter-app">Bisnis</li>
            <li data-filter=".filter-card">Pendidikan</li>
            <li data-filter=".filter-logo">Kesehatan</li>
  ...
  <div class="cta2">
    <div class="container">
      <div class="row white text-center">
        <h3 class="wd75 fnt-24">“Ketika Kamu Berinvestasi, kamu sama saja sedang membayar untuk satu hari di mana kamu
          tidak perlu bekerja.” <br> - Aya Laraya - </h3>
        <p class="cta-sub-title"></p>
        <a href="pendaftaran.html" class="btn btn-default">Mulai Investasi</a>
      </div>
    </div>
  </div>
  <!--CTA2 END-->
    ...
    <div class="container">
      <div class="row">
        <div class="page-title text-center">
          ...
          <p>Tim kami adalah orang-orang yang sudah berpengalaman dan kompeten dibidangnya! </p>
          <hr class="pg-titl-bdr-btm">
          </hr>
        </div>
        <div class="autoplay">
          <div class="col-md-6">
            <div class="team-info">
              <div class="img-sec">
                <img src="images/agent1.png" class="img-responsive">
              </div>
              <div class="fig-caption">
                <h3>Muhamad Hoerudin</h3>
                <p class="marb-20">177006056</p>
                <p>Follow me:</p>
          ...
          <div class="col-md-6">
            <div class="team-info">
              <div class="img-sec">
                <img src="images/agent2.png" class="img-responsive">
              </div>
              <div class="fig-caption">
                <h3>Anggi Dwi Astuti</h3>
                <p class="marb-20">177006076</p>
                <p>Follow me:</p>
                <ul class="team-social">
  ...
  <div id="contact" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="page-title text-center">
          <h1>Pesan Cepat</h1>
          <p>Silahkan kirim pesan kepada kami melalui form di bawah.</p>
          <hr class="pg-titl-bdr-btm">
          </hr>
        </div>
        ...
        <div class="form-sec">
          <form action="" method="post" role="form" class="contactForm">
            <div class="col-md-4 form-group">
              <input type="text" name="name" class="form-control text-field-box" id="name" placeholder="Nama Anda"
                data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
              <div class="validation"></div>
            </div>
            <div class="col-md-4 form-group">
              <input type="email" class="form-control text-field-box" name="email" id="email" placeholder="Email Anda"
                data-rule="email" data-msg="Please enter a valid email" />
              <div class="validation"></div>
            </div>
            <div class="col-md-4 form-group">
              <input type="text" class="form-control text-field-box" name="subject" id="subject" placeholder="Subjek"
            ...
            <div class="col-md-12 form-group">
              ...
              <div class="validation"></div>
              <button class="button-medium" id="contact-submit" type="submit" name="contact">Submit</button>
            </div>
          </form>
        </div>
      </div>
